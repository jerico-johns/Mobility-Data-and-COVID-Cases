...
Note that the outlier in Figure 3 is Hawaii because fewer tests were conducted over the weekend amidst a hurricane threat. We decided to include this in the regression because there was also a cluster of cases linked to failure to comply with face mask mandates and we don't know how many cases were impacted by the reporting delay.
